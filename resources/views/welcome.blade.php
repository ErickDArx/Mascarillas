...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../resources/css/flickity.css') }}" media="screen">    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js"
...
<body class="">
    ...
    <div>
        ...
        <div class="carousel-cell container img-fluid">
